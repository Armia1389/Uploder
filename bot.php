...
if(!$ok){
exit(header("location: "));//ادرس
}
error_reporting(0);
define('7915883687:AAF5PX0iOUekUD2ZhtnCmcMWEvv38Bagblg'); // توکن
$AbQ = "6457940911"; // ایدی عددی ادمین
$usernames = "hamibot"; // یوزرنیم ربات بدون @
...
$AbQs = file_get_contents("Abol.Admin");
$AbQs = explode(",",$AbQs);
if(!file_exists("Abol.Admin")){file_put_contents("Abol.Admin","$AbQ,");}
//===[ساخت دیتا]===//
...
پابلیک شد برای اولین بار در کانال آیرا تیم

منبع اول کانال های سورس
